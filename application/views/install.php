...
?>          <div class="row">
                <div class="col-md-8 center-block" id="install-info">
                    ...
                    <p class="bg-danger">After installation is complete, remove or disable access to <code>application/controllers/Install.php</code> and <code>application/sql</code>.</p>
