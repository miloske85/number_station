...
class Auth extends CI_Controller {
	...
	*/
	private function setViewData(){
		$this->_viewData = $this->config->item('number_station');
		$this->_viewData['logged_in'] = $this->ion_auth->logged_in();
		$this->_viewData['pageTitle'] = 'Reset Password';
		if($this->ion_auth->is_admin()){
			$this->_viewData['admin_url'] = base_url('admin/ap');
		}		
	}
